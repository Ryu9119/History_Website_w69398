  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Custom red palette for Thiên Sử Ký using CSS variables
        red: {
          50: 'hsl(var(--red-50))',
          100: 'hsl(var(--red-100))',
          200: 'hsl(var(--red-200))',
        ...
        // Custom green palette for difficulty levels using CSS variables
        green: {
          50: 'hsl(var(--green-50))',
        ...
        // Custom yellow palette for difficulty levels using CSS variables
        yellow: {

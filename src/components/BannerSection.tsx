      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Phương pháp học tập hiện đại và thú vị</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Được biên soạn bởi các chuyên gia lịch sử</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Truy cập dễ dàng trên mọi thiết bị</p>
          </div>
        </div>
      </div>
    </section>
